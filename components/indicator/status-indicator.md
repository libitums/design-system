...
- **한 문제의 답안 판정에는 쓰지 않습니다.** 제출한 답의 정답·오답은 [Answer Label](./answer-label.md)을 사용합니다.
...
- **접근성:** 점은 장식이므로 접근성 트리에서 숨기고, 라벨 텍스트만 읽히게 합니다. 상태가 어떤 항목의 것인지 문맥이 필요하면 `Chapter 3, Completed`처럼 항목명과 함께 알립니다 — [Accessibility](../../foundations/accessibility.md) 참고.
