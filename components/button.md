...
텍스트 라벨로 사용자의 행동을 실행하는 버튼입니다. Solid, Brand, Outline, Subtle, Text 5종을 사용합니다.
...
| 예시 | 계산 | 실제 너비 |
|---|---|---:|
| S Solid `Continue` | 52 + (12 × 2) | 76px |
| S Outline `Continue` | 52 + (12 × 2) + (1 × 2) | 78px |
| XL Solid `Continue` + 15px 아이콘 | 68 + (24 × 2) + 15 + 8 | 139px |
...
- **한 화면의 최상위 버튼은 Solid 또는 Brand 중 하나만** 둡니다.
