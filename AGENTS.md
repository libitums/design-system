...
├── web-font.md           Pretendard 제공 · Futura 라이선스 · fallback · loading 정책
...
| 웹폰트 제공·fallback | `foundations/web-font.md` → `foundations/typography.json` |
...
- **Futura 웹폰트 라이선스** — 정확한 foundry·제품·weight·사용 범위가 확인되기 전에는 파일, `@font-face`, preload를 추가할 수 없다. `foundations/web-font.md`를 따른다.
